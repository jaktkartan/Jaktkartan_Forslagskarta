...
// Ny funktion för att ladda GeoJSON-data och visa den på kartan
function loadGeoJSONData() {
    // URLs till GeoJSON-filerna
    var layerURLs = {
        'Mässor': ['bilder/Massor.geojson'],
        'Jaktkort': ['bilder/jaktkort.geojson'],
        'Jaktskyttebanor': ['bilder/jaktskyttebanor.geojson']
    };
